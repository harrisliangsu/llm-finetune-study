...
def main() -> None:
    ...
    for path in [output_dir, report_path.parent, index_path.parent, adapter_dir, generation_dir]:
    ...
    before_scores_path = output_dir / "preference_scores_before.jsonl"
    write_jsonl(before_scores_path, before_eval["rows"])
    ...
    trace.event(
        ...
        outputs={
            "preference_scores": before_scores_path,
    ...
    after_scores_path = output_dir / "preference_scores_after.jsonl"
    write_jsonl(after_scores_path, after_eval["rows"])
    ...
    trace.event(
        ...
        outputs={
            "preference_scores": after_scores_path,
