...
如果你已经知道这些名词，但不知道工程上该选哪一种训练路线，直接看 [07. 开发者训练方法指南](07-training-methods-guide.md)。那篇文档按“数据形态、优化目标、更新哪些参数、评估方式”拆解 SFT、PEFT/LoRA、DPO、RLHF、蒸馏等方法。
...
完整的开发者选型表、数据格式、训练脚本骨架和检查清单见 [07. 开发者训练方法指南](07-training-methods-guide.md)。
