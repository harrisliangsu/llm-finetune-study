...
- Lesson 02: `AutoTokenizer` 和 SFT labels，见 [reports/lesson02-tokenizer.md](../reports/lesson02-tokenizer.md)
- Lesson 03: batch、collator、padding，见 [reports/lesson03-batching.md](../reports/lesson03-batching.md)
- Lesson 04: `Trainer` 最小训练闭环，见 [reports/lesson04-trainer.md](../reports/lesson04-trainer.md)

下一步才进入 LoRA。进入前需要确认三件事：
