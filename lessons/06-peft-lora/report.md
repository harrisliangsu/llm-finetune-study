...
- train loss: 2.303504467010498
- eval loss after training: 4.882213592529297
...
| 步骤 | 作用 | 输入 | 输出 |
|---|---|---|---|
| `AutoTokenizer.from_pretrained` | 下载/加载真实模型 tokenizer | `Qwen/Qwen2.5-0.5B-Instruct` | tokenizer |
